<!DOCTYPE html>
<%@page import="com.login.Dao.budgetdao"%>
    ...
    <div class="container-fluid px-0">
      <div class="d-flex justify-content-between w-100" id="navbarSupportedContent">
        <div class="d-flex mt-4">
            <a href="budget.jsp"><button class="btn btn-block btn-primary">Back</button></a>
        </div>
        ...
        <ul class="navbar-nav align-items-center">
            ...
            <div class="dropdown-menu dashboard-dropdown dropdown-menu-right mt-2">
             ...
             <!--  <a class="dropdown-item font-weight-bold" href="#"><span class="fas fa-envelope-open-text"></span>Transactions</a>
              <a class="dropdown-item font-weight-bold" href="#"><span class="fas fa-user-shield"></span>Report</a>
       ...
       <div class="row mb-4">
         <div class="frm col-lg-6 col-sm-6">
                 <form action="budgettable.jsp">
                    <div class="mb-4 mt-4">
                      	<label class="my-1 mr-2" for="type">Type of Budget</label>
      ...
      <div class ="sanjai">  
        ...
        ResultSet rs=budget.dispaly(email, type);            			
        while(rs.next())
        {
        	out.print("<div>");
        	out.print("<h6>Category : "+rs.getString("catgory")+"</h6><br>");
        	out.print("<h6>Amount : "+rs.getInt("amount")+"</h6><br>");
        	out.print("<h6>Reason : "+rs.getString("reason")+"</h6><br>");
        	String date=rs.getString("date");
        	StringBuilder sb=new StringBuilder(date); 
        	sb.replace(10,27,"");
        	out.print("<h6>Date : "+sb+"</h6><br>");
        	out.print("</div>");
        }
        %>
      </div>  
