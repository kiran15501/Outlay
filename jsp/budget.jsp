...
<html lang="en">
  ...
  <body class="bg-soft">
    ...
    <% Dashboarddao dao=new Dashboarddao(); String user_name=dao.username(email);
                    ...
                    <li class="nav-item dropdown">
                      ...
                      >
                       ...
                       <!--  <a class="dropdown-item font-weight-bold" href="#"
                        ...
                        <a class="dropdown-item font-weight-bold" href="Logout.jsp"
                    ...
                    <div class="row mb-4">
                      <div class="frm col-lg-12 col-sm-6">
                        <form action="budget" method="post">
                          <div class="mb-4">
                            <label class="my-1 mr-2" for="type"
                              >Type of Budget</label
                            >
                            <select
                              class="form-select"
                              id="type"
