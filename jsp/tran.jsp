<!DOCTYPE html>
<%@page import="com.login.Dao.expendituredao"%>
<%@page import="com.login.Dao.incomedao"%>
...
<!-- Primary Meta Tags -->
<title>Volt Bootstrap 5 Dashboard - Transactions</title>
        ...
        <ul class="navbar-nav align-items-center">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dashboard-dropdown dropdown-menu-right mt-2">
              ...
              <a class="dropdown-item font-weight-bold" href="Lougout.jsp"><span class="fas fa-sign-out-alt text-danger"></span>Logout</a>
            </div>
          </li>
        </ul>
      </div>
...
<div class = "income">
<%
		expendituredao	expen=new expendituredao();
		ResultSet rs=expen.dispaly(email);
		while(rs.next())
		{
			...
			out.print("<div>");
			out.print("<img src="+image+" alt="+"NOImage"+">");
			out.print("<h6>Category : "+category+"</h6>");
			out.print("<br>");
			out.print("<h6> Amount : "+amount+"</h6>");
			out.print("<br>");
			out.print("<h6> reason : "+reason+"</h6>");
			out.print("</div>");
		}
%>		  
</div>
