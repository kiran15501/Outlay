            ...
            <div class="py-4">
              <div class="d-flex justify-content-center w-100 flex-wrap">
                <div class="mb-3 mb-lg-0">
                  <h1 class="h4">Voice Input From</h1>
                </div>
              </div>
            </div>
			<h5>SAY :</h5> <h6>add expense < category > < Total amount > </h6> 
			<h6>Eg : add expense food 300 </h6>
			<h6>Categories to choose from :  Food , Electricity , Medical, Gas ,Grocery ,Others </h6>
            <div class="row">
                ...
                <div class="card border-light shadow-sm components-section">
                  <div class="card-body">
                    <div class="row mb-4">
                      <div class="frm col-lg-12 col-sm-6">
                        <%
  				   String speach=(String)request.getAttribute("str");          
            	 out.print("<h6>RECOGNIZED: Text="+speach+"</h6>");
            		session=request.getSession();
            		session.setAttribute("str",speach);     	           		 
                   %> 
                    <div class="">
                    <a href="confirmtext"
                      ><button class="btn btn-block btn-primary">
