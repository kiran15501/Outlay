<!DOCTYPE html>
<%@page import="com.login.Dao.walletdao"%>
...
%>
  ...
  >
    <div class="sidebar-inner px-4 pt-3">
     ...
     <div class="row">
            <div class="col-8 col-xl-7 info"  >
              <div class="card card-body bg-white border-light shadow-sm mb-4 mt-4">
                <h2 class="h3 mt-3 mb-3">Wallet information</h2>
          
                <form action ="wallet" method ="post">
                  <div class="row">
                    <div class="col-md-6 mt-3 mb-3">
                      <div>
                        <label for="loan_amount">Add Amount</label>
                        <input class="form-control mt-2" id="loan_amount" type="number" name="total_amount" required>
                      </div>
                    </div>
                  </div>
            ...
            <div class="col-12 col-xl-5 nfo">
              <div class="row">
                <div class="col-12 mb-4 mt-4">
                  <div class="card border-light text-center p-0">
                    <div class="card-body pb-5">

                      <h4 class="h3">Balance Amount</h4>
                      <%
                      		walletdao amount=new walletdao();
                      		ResultSet rs=amount.dispaly(email);
                      		if(rs.next())
                      		{
                      			out.print("<h4>"+rs.getInt("total_amount")+"<h4>");
                      		}
                      %>
